...
<div class="form-group">
    ...
    <input type="text" id="custaddress" name ="customerAddress" placeholder="Bangkok Street" size="40">
  </div>
  
   <div class="form-group">
    <label for="custzip">ZIP</label>
    <input type="text" id="custzip" name ="customerZIP" placeholder="641097" size="40">
  </div>
  

  <div class="form-group">
    <label for="supemail">Email address</label>
    <input type="email"  id="custemail" name ="customerEmail" placeholder="aman_raj@xyz.com" size="40">
  </div>
  
  <div class="form-group">
    <label for="supemail">Password</label>
    <input type="password"  id="custpass" name ="customerPass" placeholder="******" size="40"> 
  </div>
